...
class Loop {
    ...
    start() {
        console.log('loop started : ', this._idRAF)
        this._update();
    }
    ...
    legacy = () => {
        ...
        class Loop {
            ...
            _update() {
                ...
                this._idRAF = requestAnimationFrame(this._binds.update);
                console.log('_idRAF:', this._idRAF)
            }
        ...
        <div>
            <div className={'hudCard'} ref={this.cardRef}>
                ...
                <HackLine
                    ...
                    words={this.state.lines[0]}
                    showHandler={f => this.doShowLine = f }
                />
                <Button className={'btn btn-primary m-2'} onClick={() => this.doShow()}> doShow </Button>
            </div>
        </div>
